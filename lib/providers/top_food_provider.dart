...
class TopfoodProvider with ChangeNotifier {
...
///////////////foodsProduct//////////////////
  ...
  fatchFoodsproductData() async {
    ...
    // await FirebaseService().collection("FoodsProduct").get();
    //await FirebaseFirestore.instance.collection("FoodsProduct").get();
